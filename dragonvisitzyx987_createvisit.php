...
var dragonvisitzyx987_createVisit_nonce = "<?php echo wp_create_nonce('dragonvisitzyx987_createVisit'); ?>";
...
jQuery(function() {
    ...
    jQuery('h3#createvisit_header').focus();
    myform = document.getElementById('createvisit');
...
<br/>
<h3 tabindex="0" id="createvisit_header">Create Visit:</h3>
...
<?php } ?>
<form id="createvisit" name="createvisit"  action="" method="POST" onsubmit="submitVisitData('createvisit', 'submitcreatevisit');">
    <div class="container-fluid">
        <div class="row"><br/>
          ...
          <div class="row"><br/>
            <div class="col-xs-12 col-md-12 bold" ><span tabindex="0">Visitor Name*:</span>
                <input tabindex="0" aria-label="Visitor Name" type="text" name="visitorname" id="visitorname" class="fromdate form-control bold" value="" />
            </div>
        </div>

          <div class="row"><br/>
            <div class="col-xs-12 col-md-12 bold" ><span tabindex="0">Visit Reason:</span>
                <textarea tabindex="0" aria-label="Visit Reason" name="visitreason" id="visitreason" class="form-control form-control-lg"  rows="3"></textarea>
            </div>
        </div>

        <div class="row"><br/>
            <div  class="col-xs-12 col-md-12 bold" ><span tabindex="0">Time In* (For example, 09:00, 15:45, not 9, not 3:45pm):</span>
                <br/><input tabindex="0" aria-label="Time In" type="text" name="visittimein" id="visittimein" class="fromdate timepicker form-control bold" value="" />
            </div>
        </div>

        <div class="row"><br/>
            <div  class="col-xs-12 col-md-12 bold" ><span tabindex="0">Time Out (For example, 09:00, 15:45, not 9, not 3:45pm):</span>
                <br/><input tabindex="0" aria-label="Time Out" type="text" name="visittimeout" id="visittimeout" class="fromdate timepicker form-control bold" value="" />
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <br />
                <input type="submit" id="submitcreatevisit" name="submit" class="btn btn-primary btn-lg bold" value="Submit" />
                ...
                <br/><br/><a class="btn btn-default btn-lg bold" role="button" tabindex="0" aria-label="cancel" href="<?php
                    ...
                    $myurl = remove_query_arg('action', $myurl);
        ...
        <br/>
        <div class="row">
            <input type="hidden" name="dragonvisitzyx987_hidden_security_createvisit" value="<?php echo wp_create_nonce('dragonvisitzyx987_createvisit'); ?>" />
        </div>
    </div>
</form>